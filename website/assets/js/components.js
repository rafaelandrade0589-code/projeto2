...
const SERVICES = [
  ...
  { href: 'guarda-volumes-malex.html', name: 'Controle de Guarda-Volumes e Malex',
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="7" width="18" height="14" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M12 12v3"/></svg>` },
  { href: 'sorteio-jogos.html', name: 'Sorteio e Jogos',
    icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="15" rx="2"/><path d="M12 7V4a2 2 0 0 1 2-2c1.5 0 2 1 2 2 0 1.5-2 3-4 3M12 7V4a2 2 0 0 0-2-2C8.5 2 8 3 8 4c0 1.5 2 3 4 3"/><path d="M2 13h20"/></svg>` },
...
function renderNavbar(activePage = '') {
  ...
  const logoSrc = `${base}assets/logo-worknet.png`;
...
function renderFooter() {
  ...
  const isFeiras = document.body.classList.contains('feiras-page');
  const footerLogoSrc = 'assets/logo-worknet.png';
